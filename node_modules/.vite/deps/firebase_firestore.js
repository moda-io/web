...
var ht = "__type__";
var Pt = "__max__";
var Tt = { mapValue: { fields: { __type__: { stringValue: Pt } } } };
var It = "__vector__";
var Et = "value";
var dt = { nullValue: "NULL_VALUE" };
...
*/ function __PRIVATE_applyTransformOperationToLocalView(e, t, n) {
	return e instanceof __PRIVATE_ServerTimestampTransform ? function serverTimestamp$1(e, t) {
		...
		return t && __PRIVATE_isServerTimestamp(t) && (t = __PRIVATE_getPreviousValue(t)), t && (n.fields[ut] = t), { mapValue: n };
...
function __PRIVATE_fromWatchChange(e, t) {
	...
	if ("targetChange" in t) {
		...
		n = new __PRIVATE_WatchTargetChange(r, i, s, o && function __PRIVATE_fromRpcStatus(e) {
			return new FirestoreError(void 0 === e.code ? N.UNKNOWN : __PRIVATE_mapCodeFromRpcCode(e.code), e.message || "");
		}(o) || null);
...
var Mt = /* @__PURE__ */ new Uint8Array(0);
/**
...
var __PRIVATE_IndexedDbIndexManager = class {
	constructor(e, t) {
		this.databaseId = t, this.vn = new __PRIVATE_MemoryCollectionParentIndex(), this.Fn = new ObjectMap(((e) => __PRIVATE_canonifyTarget(e)), ((e, t) => __PRIVATE_targetEquals(e, t))), this.uid = e.uid || "";
	}
	/**
	...
	*/ Bn(e, t, n, r, i, s, o) {
		...
		for (let c = 0; c < _; ++c) {
			const _ = t ? this.Ln(t[c / a]) : Mt, l = this.kn(e, _, n[c % a], r), h = this.qn(e, _, i[c % a], s), P = o.map(((t) => this.kn(e, _, t, !0)));
	...
	*/ createRange(e, t, n) {
		...
		for (const i of n) {
			...
			if (0 === n) r[0] = e.An();
			else if (n > 0 && s < 0) r.push(i), r.push(i.An());
			else if (s > 0) break;
		}
		r.push(t);
		const i = [];
	...
	*/
	...
	getNextMutationBatchAfterBatchId(e, t) {
		...
		return __PRIVATE_mutationsStore(e).ee({
			...
			t.userId === this.userId && (__PRIVATE_hardAssert(t.batchId >= n, 47524, { tr: n }), i = __PRIVATE_fromDbMutationBatch(this.serializer, t)), r.done();
		})).next((() => i));
	}
	...
	performConsistencyCheck(e) {
		return this.checkEmpty(e).next(((t) => {
			...
			return __PRIVATE_documentMutationsStore(e).ee({ range: n }, ((e, t, n) => {
				...
				__PRIVATE_hardAssert(0 === r.length, 56720, { sr: r.map(((e) => e.canonicalString())) });
			}));
		}));
	}
	containsKey(e, t) {
...
/** Provides LRU functionality for IndexedDB persistence. */ var __PRIVATE_IndexedDbLruDelegateImpl = class {
	...
	*/ Sr(e, t) {
		...
		return n.ee({ index: Ve }, (([e, n], { path: s, sequenceNumber: o }) => {
...
*/ var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
	...
	*/
	constructor(e, t) {
		super(), this.Nr = e, this.trackRemovals = t, this.Br = new ObjectMap(((e) => e.toString()), ((e, t) => e.isEqual(t)));
	}
	applyChanges(e) {
		const t = [];
	...
	getAllFromCache(e, t) {
		return this.Nr.Mr(e, t).next((({ documents: e, Or: t }) => (t.forEach(((t, n) => {
			this.Br.set(t, {
				size: n,
...
*/ var __PRIVATE_MemoryMutationQueue = class {
	...
	getAllMutationBatchesAffectingQuery(e, t) {
		...
		return this.Zr.forEachWhile(((e) => {
			const t = e.key.path;
			return !!n.isPrefixOf(t) && (t.length === r && (o = o.add(e.Yr)), !0);
...
*/ var __PRIVATE_MemoryTargetCache = class {
	constructor(e) {
		this.persistence = e, this.si = new ObjectMap(((e) => __PRIVATE_canonifyTarget(e)), __PRIVATE_targetEquals), this.lastRemoteSnapshotVersion = SnapshotVersion.min(), this.highestTargetId = 0, this.oi = 0, this._i = new __PRIVATE_ReferenceSet(), this.targetCount = 0, this.ai = __PRIVATE_TargetIdGenerator.ur();
	}
	forEachTarget(e, t) {
...
/** Performs database creation and schema upgrades. */ var __PRIVATE_SchemaConverter = class {
	...
	*/ k(e, t, n, r) {
		...
		n < 1 && r >= 1 && (function __PRIVATE_createPrimaryClientStore(e) {
			...
			e.createObjectStore(X, { keyPath: ee });
			e.createObjectStore(te, {
				keyPath: ne,
				autoIncrement: !0
			}).createIndex(re, ie, { unique: !0 }), e.createObjectStore(oe);
		...
		return n < 3 && r >= 3 && (0 !== n && (function __PRIVATE_dropQueryCache(e) {
			...
			(function __PRIVATE_createClientMetadataStore(e) {
				e.createObjectStore(we, { keyPath: Se });
			})(e);
			...
			(function __PRIVATE_createBundlesStore(e) {
				e.createObjectStore(be, { keyPath: De });
			})(e), function __PRIVATE_createNamedQueriesStore(e) {
				e.createObjectStore(Ce, { keyPath: ve });
			}(e);
		}))), n < 12 && r >= 12 && (s = s.next((() => {
			(function __PRIVATE_createDocumentOverlayStore(e) {
				const t = e.createObjectStore(Ke, { keyPath: We });
				t.createIndex(Ge, ze, { unique: !1 }), t.createIndex(je, Je, { unique: !1 });
			})(e);
		}))), n < 13 && r >= 13 && (s = s.next((() => function __PRIVATE_createRemoteDocumentCache(e) {
			const t = e.createObjectStore(_e, { keyPath: ae });
			...
			e.createObjectStore(Ne, { keyPath: Be }).createIndex(Le, ke, { unique: !1 });
			e.createObjectStore(qe, { keyPath: Qe }).createIndex($e, Ue, { unique: !1 });
			...
			(function __PRIVATE_createGlobalsStore(e) {
				e.createObjectStore(He, { keyPath: Ye });
			})(e);
	...
	*/ Si(e) {
	...
	bi(e, t) {
		...
		return t.store(H).ee({ X: !0 }, ((e, t) => {
			const n = new ResourcePath(e);
			return addEntry(n.popLast());
		})).next((() => t.store(oe).ee({ X: !0 }, (([e, t, n], r) => {
...
var __PRIVATE_IndexedDbPersistence = class __PRIVATE_IndexedDbPersistence {
	constructor(e, t, n, r, i, s, o, _, a, u, c = 18) {
		if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this.Mi = i, this.window = s, this.document = o, this.xi = a, this.Oi = u, this.Ni = c, this.ci = null, this.li = !1, this.isPrimary = !1, this.networkEnabled = !0, this.Bi = null, this.inForeground = !1, this.Li = null, this.ki = null, this.qi = Number.NEGATIVE_INFINITY, this.Qi = (e) => Promise.resolve(), !__PRIVATE_IndexedDbPersistence.v()) throw new FirestoreError(N.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
...
var __PRIVATE_QueryEngine = class {
	...
	*/ ys(e, t) {
		...
		return this.indexManager.getIndexType(e, n).next(((r) => 0 === r ? null : (null !== t.limit && 1 === r && (t = __PRIVATE_queryWithLimit(t, null, "F"), n = __PRIVATE_queryToTarget(t)), this.indexManager.getDocumentsMatchingTarget(e, n).next(((r) => {
			...
			return this.ps.getDocuments(e, i).next(((r) => this.indexManager.getMinOffset(e, n).next(((n) => {
				const s = this.Ds(t, r);
				return this.Cs(t, s, i, n.readTime) ? this.ys(e, __PRIVATE_queryWithLimit(t, null, "F")) : this.vs(e, s, t, n);
			}))));
		})))));
	}
	/**
	...
	*/ ws(e, t, n, r) {
		return __PRIVATE_queryMatchesAllDocuments(t) || r.isEqual(SnapshotVersion.min()) ? PersistencePromise.resolve(null) : this.ps.getDocuments(e, n).next(((i) => {
			const s = this.Ds(t, i);
			return this.Cs(t, s, n, r) ? PersistencePromise.resolve(null) : (__PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "Re-using previous result from %s to execute query: %s", r.toString(), __PRIVATE_stringifyQuery(t)), this.vs(e, s, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, U)).next(((e) => e)));
		}));
	}
	...
	*/ vs(e, t, n, r) {
		return this.ps.getDocumentsMatchingQuery(e, n, r).next(((e) => (t.forEach(((t) => {
			e = e.insert(t.key, t);
		})), e)));
	}
};
...
var __PRIVATE_LocalStoreImpl = class {
	constructor(e, t, n, r) {
		this.persistence = e, this.Fs = t, this.serializer = r, this.Ms = new SortedMap(__PRIVATE_primitiveComparator), this.xs = new ObjectMap(((e) => __PRIVATE_canonifyTarget(e)), __PRIVATE_targetEquals), this.Os = /* @__PURE__ */ new Map(), this.Ns = e.getRemoteDocumentCache(), this.Pi = e.getTargetCache(), this.Ii = e.getBundleCache(), this.Bs(n);
	}
	Bs(e) {
	...
	return n.persistence.runTransaction("Apply remote event", "readwrite-primary", ((e) => {
		...
		t.targetChanges.forEach(((s, _) => {
			...
			null !== t.targetMismatches.get(_) ? u = u.withResumeToken(ByteString.EMPTY_BYTE_STRING, SnapshotVersion.min()).withLastLimboFreeSnapshotVersion(SnapshotVersion.min()) : s.resumeToken.approximateByteSize() > 0 && (u = u.withResumeToken(s.resumeToken, r)), i = i.insert(_, u), function __PRIVATE_shouldPersistTargetData(e, t, n) {
				...
				if (t.snapshotVersion.toMicroseconds() - e.snapshotVersion.toMicroseconds() >= Kt) return !0;
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
	...
	return n.persistence.runTransaction("Allocate target", "readwrite", ((e) => {
		let r;
		return n.Pi.getTargetData(e, t).next(((i) => i ? (r = i, PersistencePromise.resolve(r)) : n.Pi.allocateTargetId(e).next(((i) => (r = new TargetData(t, i, "TargetPurposeListen", e.currentSequenceNumber), n.Pi.addTargetData(e, r).next((() => r)))))));
	})).then(((e) => {
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
	...
	return n.persistence.runTransaction("Get new document changes", "readonly", ((e) => n.Ns.getAllFromCollectionGroup(e, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, U), Number.MAX_SAFE_INTEGER))).then(((e) => (__PRIVATE_setMaxReadTime(n, t, e), e)));
}
...
async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r) {
	...
	const _ = i.Ns.newChangeBuffer({ trackRemovals: !0 }), a = await __PRIVATE_localStoreAllocateTarget(i, function __PRIVATE_umbrellaTarget(e) {
...
*/ var __PRIVATE_WebStorageSharedClientState = class {
	constructor(e, t, n, r, i) {
		...
		const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
		this.storage = this.window.localStorage, this.currentUser = i, this.eo = createWebStorageClientStateKey(this.persistenceKey, this.Js), this.no = function createWebStorageSequenceNumberKey(e) {
			return `firestore_sequence_number_${e}`;
		}(this.persistenceKey), this.Zs = this.Zs.insert(this.Js, new __PRIVATE_LocalClientState()), this.ro = new RegExp(`^${Wt}_${s}_([^_]*)$`), this.io = new RegExp(`^${Gt}_${s}_(\\d+)(?:_(.*))?$`), this.so = new RegExp(`^${zt}_${s}_(\\d+)$`), this.oo = function createWebStorageOnlineStateKey(e) {
						...
						if (this.ro.test(t.key)) {
							...
							const e = function __PRIVATE_fromWebStorageSequenceNumber(e) {
								...
								if (null != e) try {
									...
									__PRIVATE_hardAssert("number" == typeof n, 30636, { So: e }), t = n;
								} catch (e) {
		...
		return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, (() => {
			...
			if (!h) {
				...
				if (s) {
					...
					void 0 === n && (n = N.INTERNAL, i = "Unknown error status: " + t + " with message " + s.message), h = !0, P.a_(new FirestoreError(n, i)), c.close();
...
var __PRIVATE_RemoteStoreImpl = class {
	constructor(e, t, n, r, i) {
		this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.Ta = [], this.Ia = /* @__PURE__ */ new Map(), this.Ea = /* @__PURE__ */ new Set(), this.da = [], this.Aa = i, this.Aa.Oo(((e) => {
			n.enqueueAndForget((async () => {
				__PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(tn, "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e) {
					const t = __PRIVATE_debugCast(e);
					t.Ea.add(4), await __PRIVATE_disableNetworkInternal(t), t.Ra.set("Unknown"), t.Ea.delete(4), await __PRIVATE_enableNetworkInternal(t);
				}(this));
			}));
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
	if (e.Ra.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause) try {
		...
		await async function __PRIVATE_handleTargetError(e, t) {
			const n = t.cause;
			for (const r of t.targetIds) e.Ia.has(r) && (await e.remoteSyncer.rejectListen(r, n), e.Ia.delete(r), e.Va.removeTarget(r));
		}(e, t);
	} catch (n) {
		...
		s.sort(((e, t) => function __PRIVATE_compareChangeType(e, t) {
			const order = (e) => {
				switch (e) {
					...
					case 3: return 2;
					case 1: return 0;
					default: return fail(20277, { Rt: e });
				}
			};
...
*/ var __PRIVATE_SyncEngineImpl = class {
	constructor(e, t, n, r, i, s) {
		this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.Pu = {}, this.Tu = new ObjectMap(((e) => __PRIVATE_canonifyQuery(e)), __PRIVATE_queryEquals), this.Iu = /* @__PURE__ */ new Map(), this.Eu = /* @__PURE__ */ new Set(), this.du = new SortedMap(DocumentKey.comparator), this.Au = /* @__PURE__ */ new Map(), this.Ru = new __PRIVATE_ReferenceSet(), this.Vu = {}, this.mu = /* @__PURE__ */ new Map(), this.fu = __PRIVATE_TargetIdGenerator.cr(), this.onlineState = "Unknown", this.gu = void 0;
	}
	get isPrimaryClient() {
		return !0 === this.gu;
	}
...
*/ async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
	e.pu = (t, n, r) => async function __PRIVATE_applyDocChanges(e, t, n, r) {
		let i = t.view.ru(n);
		i.Cs && (i = await __PRIVATE_localStoreExecuteQuery(e.localStore, t.query, !1).then((({ documents: e }) => t.view.ru(e, i))));
...
*/ async function __PRIVATE_syncEngineRejectListen(e, t, n) {
	...
	if (s) {
		...
		await __PRIVATE_syncEngineApplyRemoteEvent(r, new RemoteEvent(SnapshotVersion.min(), /* @__PURE__ */ new Map(), new SortedMap(__PRIVATE_primitiveComparator), e, n)), r.du = r.du.remove(s), r.Au.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r);
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
	...
	if (e.Iu.delete(t), e.isPrimaryClient) e.Ru.jr(t).forEach(((t) => {
		e.Ru.containsKey(t) || __PRIVATE_removeLimboTarget(e, t);
	}));
}
...
async function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
	...
	if (!n.currentUser.isEqual(t)) {
		...
		}(n, "'waitForPendingWrites' promise is rejected due to a user change."), n.sharedClientState.handleUserChange(t, e.removedBatchIds, e.addedBatchIds), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e.Ls);
	}
}
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
	...
	if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), !0 === t && !0 !== n.gu) {
		...
		n.Iu.forEach(((r, i) => {
			...
			})), t.Ru.Jr(), t.Au = /* @__PURE__ */ new Map(), t.du = new SortedMap(DocumentKey.comparator);
...
*/ function __PRIVATE_syncEngineLoadBundle(e, t, n) {
	...
	async function __PRIVATE_loadBundleImpl(e, t, n) {
		try {
			...
			return __PRIVATE_logWarn(sn, `Loading bundle failed with ${e}`), n._failWith(e), Promise.resolve(/* @__PURE__ */ new Set());
		}
	})(r, t, n).then(((e) => {
		/**
		* @license
...
*/ var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
	...
	async initialize(e) {
		...
		}, await this.sharedClientState.start()), await this.persistence.Ji((async (e) => {
...
*/ var __PRIVATE_BundleReaderImpl = class {
	constructor(e, t) {
		this.Bu = e, this.serializer = t, this.metadata = new __PRIVATE_Deferred(), this.buffer = /* @__PURE__ */ new Uint8Array(), this.Lu = function __PRIVATE_newTextDecoder() {
			return new TextDecoder("utf-8");
		}(), this.ku().then(((e) => {
			e && e.$a() ? this.metadata.resolve(e.Qa.metadata) : this.metadata.reject(/* @__PURE__ */ new Error(`The first element of the bundle is not a metadata, it is\n             ${JSON.stringify(e?.Qa)}`));
...
var Transaction$2 = class {
	...
	async lookup(e) {
		...
		const t = await async function __PRIVATE_invokeBatchGetDocumentsRpc(e, t) {
			const n = __PRIVATE_debugCast(e), r = { documents: t.map(((e) => __PRIVATE_toName(n.serializer, e))) }, i = await n.Ho("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r, t.length), s = /* @__PURE__ */ new Map();
			i.forEach(((e) => {
...
async function __PRIVATE_setOnlineComponentProvider(e, t) {
	...
	__PRIVATE_logDebug(on, "Initializing OnlineComponentProvider"), await t.initialize(n, e.configuration), e.setCredentialChangeListener(((e) => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, e))), e.setAppCheckTokenChangeListener(((e, n) => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, n))), e._onlineComponents = t;
}
/**
	...
	if (!e._offlineComponents) if (e._uninitializedComponentsProvider) {
		...
		try {
			...
			if (!function __PRIVATE_canFallbackFromIndexedDbError(e) {
				return "FirebaseError" === e.name ? e.code === N.FAILED_PRECONDITION || e.code === N.UNIMPLEMENTED : !("undefined" != typeof DOMException && e instanceof DOMException) || 22 === e.code || 20 === e.code || 11 === e.code;
			}(n)) throw n;
...
/** Disables the network connection. Pending operations will not complete. */ function __PRIVATE_firestoreClientDisableNetwork(e) {
	return e.asyncQueue.enqueue((async () => {
		...
		return t.setNetworkEnabled(!1), async function __PRIVATE_remoteStoreDisableNetwork(e) {
			const t = __PRIVATE_debugCast(e);
			t.Ea.add(0), await __PRIVATE_disableNetworkInternal(t), t.Ra.set("Offline");
		}(n);
	}));
}
/**
...
function __PRIVATE_firestoreClientGetDocumentsFromLocalCache(e, t) {
	...
	return e.asyncQueue.enqueueAndForget((async () => async function __PRIVATE_executeQueryFromCache(e, t, n) {
		try {
			const r = await __PRIVATE_localStoreExecuteQuery(e, t, !0), i = new __PRIVATE_View(t, r.Qs), s = i.ru(r.documents), o = i.applyChanges(s, !1);
	...
	return e.asyncQueue.enqueueAndForget((async () => {
		try {
			...
			r.resolve(async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
				...
				const _ = (await r.Ho("RunAggregationQuery", r.serializer.databaseId, o, i, 1)).filter(((e) => !!e.result));
...
*/ function initializeFirestore(e, t, n) {
	...
	if (r.isInitialized(n)) {
		const e = r.getImmediate({ identifier: n }), i = r.getOptions(n);
		...
		*/
		return function __PRIVATE_parseVectorValue(e, t) {
			return { mapValue: { fields: {
				[ht]: { stringValue: It },
				[Et]: { arrayValue: { values: e.toArray().map(((e) => {
...
function onSnapshotResume(e, t, ...n) {
	const r = getModularInstance(e), i = function __PRIVATE_normalizeSnapshotJsonFields(e) {
		const t = {
			bundle: "",
			bundleName: "",
			bundleSource: ""
	...
	if ("object" != typeof n[o] || __PRIVATE_isPartialObserver(n[o]) || (s = n[o++]), "QuerySnapshot" === i.bundleSource) {
		...
		*/
		return function __PRIVATE_onSnapshotQuerySnapshotBundle(e, t, n, r, i) {
			let s, o = !1;
			return loadBundle(e, t.bundle).then((() => namedQuery(e, t.bundleName))).then(((e) => {
				if (e && !o) i && e.withConverter(i), s = onSnapshot(e, n || {}, r);
	...
	if ("DocumentSnapshot" === i.bundleSource) {
		...
		return function __PRIVATE_onSnapshotDocumentSnapshotBundle(e, t, n, r, i) {
			let s, o = !1;
			return loadBundle(e, t.bundle).then((() => {
				if (!o) s = onSnapshot(new DocumentReference(e, i || null, DocumentKey.fromPath(t.bundleName)), n || {}, r);
			})).catch(((e) => (r.error && r.error(e), () => {}))), () => {
				o || (o = !0, s && s());
			};
		}(r, i, s, e, n[o]);
